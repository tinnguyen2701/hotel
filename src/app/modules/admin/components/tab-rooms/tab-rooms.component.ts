...
export class TabRoomsComponent implements OnInit {
    ...
    onFindRooms() {
        if (this.searchAutoGeneratedRoom.numberOfSingleRooms || this.searchAutoGeneratedRoom.numberOfDoubleRooms) {
            this.bookingsService.findListAvailableRooms(this.searchAutoGeneratedRoom).subscribe(rs => {
                this.rooms = rs;
